...
namespace School_Management_System {
    ...
    public partial class schoolDataSet : global::System.Data.DataSet {
        ...
        public partial class classesDataTable : global::System.Data.TypedTableBase<classesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public classesRow AddclassesRow(string class_name, double fees) {
    ...
    public partial class classesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[classes] WHERE (([class_id] = @Original_class_id) AND ([class_" +
                "name] = @Original_class_name) AND ((@IsNull_fees = 1 AND [fees] IS NULL) OR ([fe" +
                "es] = @Original_fees)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[classes] ([class_name], [fees]) VALUES (@class_name, @fees);\r\n" +
                "SELECT class_id, class_name, fees FROM classes WHERE (class_id = SCOPE_IDENTITY(" +
                "))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[classes] SET [class_name] = @class_name, [fees] = @fees WHERE (([class_id] = @Original_class_id) AND ([class_name] = @Original_class_name) AND ((@IsNull_fees = 1 AND [fees] IS NULL) OR ([fees] = @Original_fees)));
SELECT class_id, class_name, fees FROM classes WHERE (class_id = @class_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT class_id, class_name, fees FROM dbo.classes";
        ...
        public virtual int Delete(int Original_class_id, string Original_class_name, global::System.Nullable<double> Original_fees) {
        ...
        public virtual int Insert(string class_name, global::System.Nullable<double> fees) {
            if ((class_name == null)) {
        ...
        public virtual int Update(string class_name, global::System.Nullable<double> fees, int Original_class_id, string Original_class_name, global::System.Nullable<double> Original_fees, int class_id) {
            if ((class_name == null)) {
                throw new global::System.ArgumentNullException("class_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string class_name, global::System.Nullable<double> fees, int Original_class_id, string Original_class_name, global::System.Nullable<double> Original_fees) {
            return this.Update(class_name, fees, Original_class_id, Original_class_name, Original_fees, Original_class_id);
        }
    }
